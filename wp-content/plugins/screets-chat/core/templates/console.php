...
<div id="schat-console" class="schat-w schat-container">
	...
	<div id="schat-settings" class="schat-settings">
		<div class="schat-wrap">
			...
			<form action="" class="schat-form-settings">
				...
				<div class="schat-field">
					<label>Tools:</label>
					<a href="javascript:;" id="schat-btn-logout" class="button schat-btn-logout schat-tooltip" data-title="<?php _e( 'It is useful to refresh only your connection', 'schat' ); ?>"><?php _e( 'Re-login', 'schat' ); ?></a>
					<?php if( current_user_can( 'manage_options' ) ): ?>
						<a href="javascript:;" id="schat-btn-reset" class="button schat-btn-reset schat-tooltip schat-tooltip-r" style="color:#e54045" data-title="<?php _e( 'It is helpful if something wrong in chat connections or chat transmissions. It doesn\'t delete chat data', 'schat' ); ?>"><?php _e( 'Restart', 'schat' ); ?></a>
					<?php endif; ?>

					<hr>

					<a href="https://<?php echo $SChat->opts->getOption('app-id');?>.firebaseio.com/" id="schat-btn-db" class="schat-btn-db" target="_blank"><i class="schat-ico-database"></i>Database</a>
				</div>
	...
	<div class="schat-top-nav schat-group">
		...
		<!-- Top navigation -->
		<ul class="schat-nav">
			<li><a href="<?php echo SLC_PLUGIN_URL; ?>" target="_blank"><strong>Live Chat</strong> <?php echo SLC_EDITION; ?></a></li>
