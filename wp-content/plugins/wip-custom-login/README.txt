...
Tags: custom login, wordpress login, customization, themes, plugins, wp-login
...
https://www.themeinprogress.com/c-login-free-custom-login-wordpress-plugin

== Description ==

Install WIP Custom Login to change the default style of WordPress login section.
...
2. Alternative custom login page
3. Option panel
...
* Fixed: Compatibility with WordPress 4.6
