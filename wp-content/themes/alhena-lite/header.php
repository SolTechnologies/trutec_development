...
<div id="wrapper">
    ...
    <div id='global' class="row">
        <div class="container">
            <ul>
                <li class="offers">WARRANTY / FREE SHIPPING / CUSTOMER SERVICE / PRODUCTS</li>
                <li class="num"><span class="telNum">(888) 555-5555</span>   <span class="hrs">(24 HOURS / 7 DAYS A WEEK)</span></li>
            </ul>
        </div>
