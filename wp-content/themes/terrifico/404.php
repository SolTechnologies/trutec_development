...
<div id="main" class="<?php echo esc_attr($terrifico_theme_options['layout_settings']);?>">
	<div class="content-posts-wrap">
		<div id="content-box">
			<div id="post-body">
				<h1><?php esc_attr_e('Error 404 - Page not found!', 'terrifico'); ?></h1>
				<div class="sorry"><?php esc_attr_e('Sorry! It seems that the page you are looking for is not here.', 'terrifico'); ?></div>
			</div><!--post-body-->
		</div><!--content-box-->
