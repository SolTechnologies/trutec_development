...
<?php } ?>
	<div id="content-boxes-wrap">
		<div class="col wow bounceIn" data-wow-delay="0.2s">
			...
			<a class="content-btn" href="<?php echo esc_url($terrifico_theme_options['first_column_url']); ?>"><?php esc_attr_e('Read More','terrifico'); ?></a>
		</div>
		<div class="col wow bounceIn" data-wow-delay="0.5s">
			...
			<a class="content-btn" href="<?php echo esc_url($terrifico_theme_options['second_column_url']); ?>"><?php esc_attr_e('Read More','terrifico'); ?></a>
		</div>
		<div class="col wow bounceIn" data-wow-delay="0.8s">
			...
			<a class="content-btn" href="<?php echo esc_url($terrifico_theme_options['third_column_url']); ?>"><?php esc_attr_e('Read More','terrifico'); ?></a>
		</div>
	</div>
</div>
